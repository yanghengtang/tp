...
public class AddAppointmentCommandParser implements NewParser<AddAppointmentCommand> {
    ...
    public AddAppointmentCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_PATIENT_NRIC, PREFIX_DOCTOR_NRIC, PREFIX_APPOINTMENT_START_TIME, PREFIX_APPOINTMENT_END_TIME);

        if (!arePrefixesPresent(argMultimap, PREFIX_PATIENT_NRIC, PREFIX_DOCTOR_NRIC, PREFIX_APPOINTMENT_START_TIME, PREFIX_APPOINTMENT_END_TIME)
